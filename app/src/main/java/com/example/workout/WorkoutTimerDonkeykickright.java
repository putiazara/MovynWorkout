...
public class WorkoutTimerDonkeykickright extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.workout_timer_donkeykickright);
        ...
        timer = new CountDownTimer(31 * 1000, 1000) {
            ...
            public void onFinish() {
                if (ketAwal) {
                    Intent intent = new Intent(getApplicationContext(), WorkoutResultButt.class);
                    ...
                    intent.putExtra("ketDonkeyLeft", ketDonkeyLeft);
                    intent.putExtra("ketDonkeyRight", true);
        ...
        btnNext.setOnClickListener(view -> {
            ...
            intent.putExtra("ketGlute", ketGlute);
            intent.putExtra("ketDonkeyLeft", ketDonkeyLeft);
            intent.putExtra("ketDonkeyRight", false);
            startActivity(intent);
            finish();
        });
