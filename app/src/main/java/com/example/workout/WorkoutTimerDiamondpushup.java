...
public class WorkoutTimerDiamondpushup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.workout_timer_diamondpushup);
        ...
        timer = new CountDownTimer(31 * 1000, 1000) {
            ...
            public void onFinish() {
                if (ketAwal) {
                    Intent intent = new Intent(getApplicationContext(), WorkoutTimerAlternatehammercurl.class);
                    intent.putExtra("startAwal", ketAwal);
                    intent.putExtra("ketArmRaises", ketArmRaises);
                    intent.putExtra("ketSidearm", ketSidearm);
                    intent.putExtra("ketDiamond", true);
