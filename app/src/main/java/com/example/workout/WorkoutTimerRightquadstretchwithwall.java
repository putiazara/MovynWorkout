...
public class WorkoutTimerRightquadstretchwithwall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.workout_timer_rightquadstretchwithwall);
        ...
        timer = new CountDownTimer(31 * 1000, 1000) {
            ...
            public void onFinish() {
                if (ketAwal) {
                    Intent intent = new Intent(getApplicationContext(), WorkoutResultLeg.class);
                    ...
                    intent.putExtra("ketLeftQuad", ketLeftQuad);
                    intent.putExtra("ketRighQuad", true);
        ...
        btnNext.setOnClickListener(view -> {
            ...
            intent.putExtra("ketBackward", ketBackward);
            intent.putExtra("ketLeftQuad", ketLeftQuad);
            intent.putExtra("ketRighQuad", false);
            startActivity(intent);
            finish();
        });
