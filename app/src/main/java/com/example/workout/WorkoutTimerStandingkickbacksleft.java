...
public class WorkoutTimerStandingkickbacksleft extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.workout_timer_standingkickbacksleft);
