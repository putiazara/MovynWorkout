...
public class WorkoutTimerInclinepushup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.workout_timer_inclinepushup);
        ...
        timer = new CountDownTimer(31 * 1000, 1000) {
            ...
            public void onFinish() {
                if (ketAwal) {
                    Intent intent = new Intent(getApplicationContext(), WorkoutTimerCobrastretch2.class);
                    intent.putExtra("startAwal", ketAwal);
                    intent.putExtra("ketPushup", ketPushup);
                    intent.putExtra("ketWidearm", ketWidearm);
                    intent.putExtra("ketKnee", ketKnee);
                    intent.putExtra("KetIncline", true);
