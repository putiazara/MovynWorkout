...
public class WorkoutTimerGlutebridge extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.workout_timer_glutebridge);
        ...
        timer = new CountDownTimer(31 * 1000, 1000) {
            ...
            public void onFinish() {
                if (ketAwal) {
                    Intent intent = new Intent(getApplicationContext(), WorkoutTimerDonkeykickleft.class);
