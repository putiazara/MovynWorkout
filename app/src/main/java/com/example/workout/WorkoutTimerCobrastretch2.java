...
public class WorkoutTimerCobrastretch2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.workout_timer_cobrastretch2);
        ...
        timer = new CountDownTimer(31 * 1000, 1000) {
            ...
            public void onFinish() {
                if (ketAwal) {
                    Intent intent = new Intent(getApplicationContext(), WorkoutResultChest.class);
                    ...
                    intent.putExtra("KetIncline", ketIncline);
