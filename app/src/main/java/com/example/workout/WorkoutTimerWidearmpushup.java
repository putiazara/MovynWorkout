...
public class WorkoutTimerWidearmpushup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.workout_timer_widearmpushup);
        ...
        timer = new CountDownTimer(31 * 1000, 1000) {
            ...
            public void onFinish() {
                if (ketAwal) {
                    Intent intent = new Intent(getApplicationContext(), WorkoutTimerKneepushup.class);
                    intent.putExtra("startAwal", ketAwal);
                    intent.putExtra("ketPushup", ketPushup);
                    intent.putExtra("ketWidearm", true);
